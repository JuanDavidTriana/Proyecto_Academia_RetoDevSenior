...
class DocenteController:
    ...
    def registrar_docente(self, nombre, apellido, correo, telefono, especialidad):
        ...
        :param correo: correo electr nico del docente
        :param telefono: tel fono del docente
        :param especialidad: especialidad del docente
        """
        sql = """
            INSERT INTO docentes (nombre, apellido, correo, telefono, especialidad)
            VALUES (%s, %s, %s, %s, %s)
        """
    ...
    def listar_docentes(self):
        ...
        """
        sql = """SELECT id_docente, nombre, apellido, correo, telefono, especialidad FROM docentes"""
    ...
    def obtener_docente_por_id(self, id_docente):
        ...
        """
        sql = """SELECT id_docente, nombre, apellido, correo, telefono, especialidad FROM docentes WHERE id_docente = %s"""
        params = (id_docente,)
    ...
    def actualizar_docente(self, id_docente, nombre, apellido, correo, telefono, especialidad):
        ...
        :param correo: nuevo correo electr nico del docente
        :param telefono: nuevo tel fono del docente 
        :param especialidad: nueva especialidad del docente
        """
        sql = """
            UPDATE docentes SET nombre = %s, apellido = %s, correo = %s, telefono = %s, especialidad = %s WHERE id_docente = %s
        """
